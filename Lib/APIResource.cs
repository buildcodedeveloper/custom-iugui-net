...
namespace iugu.net.Lib
{
    ...
    public class APIResource : IApiResources
    {
        ...
        /// </summary>
        public APIResource(IHttpClientWrapper customClient, JsonSerializerSettings customJsonSerializerSettings = null, string iuguApiKey = null)
        {
            client = customClient;
            ...
            _apiKey = iuguApiKey ?? ConfigurationManager.AppSettings["iuguApiKey"];
        ...
        /// </summary>
        /// <param name="iuguApiKey"></param>
        public APIResource(string iuguApiKey = null) : this(new StandardHttpClient(),
            new JsonSerializerSettings { NullValueHandling = NullValueHandling.Ignore }, iuguApiKey)
        {
        }
